...
add wave -noupdate -format Analog-Step -height 84 -label {Sum data in} -max 21472468812.0 -radix unsigned /filter_test_tb/c1/sum_ram_data_in
add wave -noupdate -label {Sum read addr} -radix unsigned /filter_test_tb/c1/sum_read_addr
add wave -noupdate -format Analog-Step -height 84 -label {Sum ram data out} -max 21472468812.0 -radix unsigned /filter_test_tb/c1/sum_ram_data_out
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {295715000 ps} 0}
