...
add wave -noupdate -format Analog-Step -height 84 -label {filt ram out} -max 5.2772200000000015e+26 -min -5.2078599999999998e+26 /filter_test_tb/c1/filt_ram_data_out
...
add wave -noupdate -format Analog-Step -height 84 -label {proc ram data in} -max 28653900.0 -min -28540000.0 -radix decimal /filter_test_tb/c1/proc_ram_data_in
...
add wave -noupdate -format Analog-Step -height 84 -label {Sum data in} -max 17204184778.0 -radix unsigned /filter_test_tb/c1/sum_ram_data_in
add wave -noupdate -label {Sum read addr} -radix unsigned /filter_test_tb/c1/sum_read_addr
add wave -noupdate -format Analog-Step -height 84 -label {Sum ram data out} -max 17204184778.0 -radix unsigned /filter_test_tb/c1/sum_ram_data_out
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1116455000 ps} 0}
