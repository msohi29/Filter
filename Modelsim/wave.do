...
add wave -noupdate -format Analog-Step -height 84 -label filtered -max 4.0503599999999992e+26 -min -4.05995e+26 /filter_test_tb/c1/filtered
...
add wave -noupdate -label {filt data in} -radix decimal -radixshowbase 0 /filter_test_tb/c1/filt_ram_data_in
add wave -noupdate -format Analog-Step -height 84 -label {filt ram out} -max 4.0503599999999992e+26 -min -4.05995e+26 /filter_test_tb/c1/filt_ram_data_out
...
WaveRestoreCursors {{Cursor 1} {8740125 ps} 0}
...
update
WaveRestoreZoom {0 ps} {3486336 ps}
